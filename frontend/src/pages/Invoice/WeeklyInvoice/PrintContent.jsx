                                                ...
                                                <>
                                                    <td className="text-[10px] font-medium text-[#111827] p-2 border border-[#E5E7EB]">
                                                        {item.additionalServiceApproval === 'Requested' ? (
                                                            ...
                                                            item.additionalServiceDetails?.service === 'Route Support' ? `${item.incentiveDetailforAdditional[0]?.routeSupportService} (Route Support )` : `${item.additionalServiceDetails?.service === 'Other' && item.additionalServiceDetails?.remarks ? `${item.additionalServiceDetails?.remarks} (Other)` : item.additionalServiceDetails?.service || '-'} `
                                                        )}
                                                    </td>
