...
const SuccessTick = ({ onComplete, width, height }) => {
    ...
    return (
        <div className="flex items-center justify-center">
            ...
            <div style={{ height, width }} className={`w-20 h-20 bg-green-500 rounded-full flex items-center justify-center shadow-lg transform transition-all duration-500 ${show ? "scale-100 opacity-100 " : "scale-0 opacity-0"}`}>
                <svg
