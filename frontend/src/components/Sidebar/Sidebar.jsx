...
const Sidebar = ({ sidebarIsOpen }) => {
    ...
    return (
        <div className={`h-full bg-neutral-200 inset-shadow-md inset-shadow-stone-700/30 overflow-auto w-60  transition duration-300 origin-left ${sidebarIsOpen ? '' : '-translate-x-60'} `}>
            <div className='mb-12'>
