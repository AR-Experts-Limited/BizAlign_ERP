...
const Sidebar = ({ sidebarIsOpen }) => {
    ...
    return (
        <div className={`h-full bg-neutral-300/80 shadow-[inset_-2px_0_4px_rgba(0,0,0,0.1)]  overflow-auto w-60  transition duration-300 origin-left ${sidebarIsOpen ? '' : '-translate-x-60'} `}>
            <div className='mb-12'>
